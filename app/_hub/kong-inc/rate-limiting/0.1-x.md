  ...
  config:
    ...
    - name: policy
      ...
      description: |
        ...
        In case of DB-less mode, atleast one of `local` or 'redis` must be specified. Please refer <a href="https://docs.konghq.com/hub/kong-inc/rate-limiting/#implementation-considerations">Implementation Considerations</a> for details on which policy should be used.
    - name: fault_tolerant
      required: false
      default: "`true`"
      description: |
